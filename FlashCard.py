...
from PyQt5.QtWidgets import QApplication, QMainWindow,QInputDialog,QLineEdit,QMessageBox,QColorDialog,QFileDialog, QGraphicsScene, QGraphicsView, QGraphicsItem, QGraphicsEllipseItem, QGraphicsRectItem
from PyQt5.QtWidgets import QApplication, QMainWindow, QGraphicsScene, QGraphicsView, QGraphicsItem, QLabel, QVBoxLayout, QPushButton, QWidget,QGraphicsPixmapItem,QGraphicsRectItem,QGraphicsEllipseItem
...
class FlashCardApp(QMainWindow):
    ...
    def change_window(self,window):
        if self.window.flash_card_options.currentText() == "Basic" or self.add_card_ui.flash_card_options.currentText() == "Basic (and Reversed card)":
    ...
    def Insert_image_in_Label(self):
        ...
        if file_name:
            ...
            # self.scene = QGraphicsScene(self.image_edit_window)

            # self.image_item = QGraphicsPixmapItem(QPixmap(file_name))
